...
def enwords():
    enword = open(absolute_path + "english_words.txt", "r")
...
def eswords():
    esword = open(absolute_path + "spanish_words.txt", encoding="latin1")
...
def ptwords():
    ptword = open(absolute_path + "portuguese_words.txt", encoding="latin1")
...
def itwords():
    itword = open(absolute_path + "italian_words.txt", encoding="latin1")
...
def dewords():
    deword = open(absolute_path + "german_words.txt", encoding="cp1252")
...
def frwords():
    frword = open(absolute_path + "french_words.txt", encoding="latin1")
...
def set_italian(self):
    self.language = ["Indovina la parola: \n",  # 0
                     ...
                     "\nPunti perse: ",  # 14
                     "\nMedia: ",  # 15
                     "Quello linguaggio non è supportato. Richiedilo (Vedi la descrizione). Tenta un altra volta.",
                     # 16
                     "Facile - 10 Vite",  # 17
...
def set_german(self):
    self.language = ["Errate das Wort : \n",  # 0
                     ...
                     "\nNiederlagen: ",  # 14
                     "\nDurschnitt: ",  # 15
                     "Diese Sprache wird nicht unterstützt, bitte anfragen (Siehe die Anleitung im Bot). "
                     "Versuche es erneut!",  # 16
...
def set_french(self):
    self.language = ["Devinez le mot: \n",  # 0
                     ...
                     "\nDéfaites: ",  # 14
                     "\nMoyenne: ",  # 15
                     "Cette langue n'est pas prise en charge, demandez la (Voir la description du bot). "
                     "Essayez encore!",  # 16
